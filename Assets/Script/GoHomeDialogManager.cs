...
public class GoHomeDialogManager: MonoBehaviour
{
    ...
    IEnumerator StartFinalAni()
    {
        ...
        twoPeopleAni.SetBool("isTwo", true); // 두 사람 걸어가는 장면 나옴

        yield return new WaitForSeconds(1.5f);

        twoPeopleAni.SetBool("isTwo", false);
        handAni.SetBool("isHand", true);

        yield return new WaitForSeconds(1.5f);

        handAni.SetBool("isHand", false);
