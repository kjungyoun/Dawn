...
public class EnemyFSM : MonoBehaviour
{
	...
	private PacManMovementScript movement2D;
	...
	private void Awake()
	{
		...
		movement2D = GetComponent<PacManMovementScript>();
	...
	{
		// 이동 방향을 임의로 설정해서 SetMoveDirection() 함수 호출
	...
	private IEnumerator SetMoveDirectionByTime()
	{
		...
		// 현재 이동 방향이 Right or Left이면 direction%2는 0으로
